...
The following code allows to reproduce Figure 1 of Boulaguiem et al. (2023):
...
To visually assess equivalence with the interval inclusion principal, we reproduce Figure 2 of Boulaguiem et al. (2023) with the following code: 
